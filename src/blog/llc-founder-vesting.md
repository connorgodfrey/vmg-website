...
tags:
  - blog
layout: layout.njk
description: "Most first-time founders think vesting is something Delaware startups do with stock. LLC membership interests can vest too, and if yours don't, a departed co-founder keeps every point of equity they were ever granted. Here is how LLC vesting works, including the 30-day tax election you cannot miss."
---
...
- **Leaver definitions.** What happens on death or disability (usually accelerated or fully vested), a firing without cause, or a walk-away? The difference between a "good leaver" and a "bad leaver" clause is the difference between an amicable exit and litigation.
- **Acceleration.** Full or partial vesting on a sale of the company (and, more conservatively, only if the buyer also terminates the founder: the "double trigger") protects founders from being vested out of their own exit.
- **What happens to forfeited units.** Cleanest is redemption by the company, which lifts every remaining member proportionately.
