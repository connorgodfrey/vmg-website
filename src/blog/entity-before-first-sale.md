...
tags:
  - blog
layout: layout.njk
description: "No law requires you to form an LLC before selling. But until you do, you are the business: every promise, contract, and mistake is personally yours, and a DBA won't change that. What actually starts the clock, what formation costs in New York, and when the answer flips to 'yes, now.'"
---
...
Operate alone without filing anything and you are a sole proprietorship by default. Every contract is signed by you personally, every dollar of business debt is your debt, and every claim (the workshop attendee who trips, the client who says your advice cost them money, the vendor dispute) reaches your personal savings and, potentially, your home. There is no line between business assets and yours, because legally there is no business; there is only you, doing business.

Add a co-founder and the default gets stranger: two people building and sharing profits together are a general partnership under New York law, no filing or intent required, and each of you is personally liable for obligations the other creates. That trap is big enough to get its own memo in this series ([Partnership by Accident](/blog/partnership-by-accident/)).

One more piece founders miss: forming an entity later does not clean up what came before. Contracts you sign before the company exists are yours personally, and they generally stay yours even after formation. The new LLC can adopt the contract, but you typically remain on the hook unless the other side agrees to release you. Signing "for a company I'll form soon" is still signing.

## A DBA Is a Name, Not a Shield

Founders often file a DBA (a certificate of assumed name) and feel officially in business. Worth being precise about what that filing does. Under General Business Law § 130, a sole proprietor or partnership operating under any name other than the owners' real names must file an assumed name certificate with the county clerk in each county where business is transacted. Fees vary by county (Erie County charges $35; New York County charges $100). Skipping it has consequences: you cannot maintain a lawsuit on your contracts until you file, and non-compliance is technically a misdemeanor.

So the DBA is legally required if you use a trade name. What it is not, is protection. It creates no entity, shields no assets, and changes nothing about personal liability. It is a name registration, full stop.
...
- **A co-founder.** You already have an entity at that point: a general partnership with default terms you would never choose. Forming the LLC is not adding structure; it is replacing bad structure.
- **A signed contract of any weight**, since pre-formation signatures follow you.
- **Physical risk or products**: premises, events, anything ingestible or wearable, anything that can break.
- **An employee or real revenue**, both of which raise the stakes and the regulatory surface.

For a two-founder business, in other words, the answer is effectively always "yes, now." For a solo founder, it is "soon, and before anything listed above."

---

## Conclusion

The fear that you are doing it wrong by selling early is usually misplaced; the risk is not illegality, it is exposure. Form the entity when the exposure outweighs a few hundred dollars and a week of paperwork, and notice how early that line actually arrives, especially the moment a partner is involved.
